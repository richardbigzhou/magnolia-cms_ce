...
public abstract class AbstractMagnoliaUITest extends AbstractMagnoliaIntegrationTest {
    ...
    protected WebElement getMoveDialogElement(String elementName) {
        return getElementByXpath("//div[contains(@class, 'dialog-root')]//div[contains(@class, 'dialog-content')]//div[contains(@class, 'v-slot-keyboard-panel')]//div[@class='v-table-cell-wrapper' and text() = '%s']", elementName);
    }
